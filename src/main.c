...
static const Vec x86dec_vectors[] = {
  ...
  {"\x9C", 1, 0, X86DEC_OK, MN(PUSHF), 1, "pushf"},
  {"\x9D", 1, 0, X86DEC_OK, MN(POPF), 1, "popf"},
  ...
  {"\x0F\xAE\x38", 3, 0, X86DEC_OK, MN(CLFLUSH), 3, "clflush byte ptr ds:[rax]"},
  {"\x0F\xC7\xF6", 3, 0, X86DEC_OK, MN(RDRAND), 3, "rdrand esi"},
  {"\x0F\xC7\xFF", 3, 0, X86DEC_OK, MN(RDSEED), 3, "rdseed edi"},
  {"\xF3\x0F\xC7\xF8", 4, 0, X86DEC_OK, MN(RDPID), 4, "rdpid eax"},
  ...
  {"\xCA\x04\x00", 3, 0, X86DEC_OK, MN(RETF), 3, "retf 0x4"},
  {"\xCB", 1, 0, X86DEC_OK, MN(RETF), 1, "retf"},
  ...
  {"\x9B", 1, 0, X86DEC_OK, MN(WAIT), 1, "wait"},
  ...
  {"\x0F\x1F\x00", 3, 0, X86DEC_OK, MN(NOP), 3, "nop dword ptr ds:[rax]"},
  {"\x48\x0F\x78\xC1", 4, 0, X86DEC_OK, MN(VMREAD), 4, "vmread rax, rcx"},
  {"\x48\x0F\x79\xC1", 4, 0, X86DEC_OK, MN(VMWRITE), 4, "vmwrite rax, rcx"},
  {"\x0F\x02\xC0", 3, 0, X86DEC_OK, MN(LAR), 3, "lar eax, ax"},
  {"\x0F\x03\xC0", 3, 0, X86DEC_OK, MN(LSL), 3, "lsl eax, ax"},
  {"\x0F\xB2\x08", 3, 0, X86DEC_OK, MN(LSS), 3, "lss ecx, dword ptr ds:[rax]"},
  {"\x0F\xB4\x08", 3, 0, X86DEC_OK, MN(LFS), 3, "lfs ecx, dword ptr ds:[rax]"},
  {"\x8D\x04\x25\x00\x10\x00\x00", 7, 0, X86DEC_OK, MN(LEA), 7,
      "lea eax, dword ptr [rip+0x1000]"},
  ...
  {"\x62\x03", 2, 1, X86DEC_OK, MN(BOUND), 2, "bound eax, dword ptr ds:[ebx]"},
  {"\xC4\x03", 2, 1, X86DEC_OK, MN(LES), 2, "les eax, dword ptr ds:[ebx]"},
  {"\xC5\x03", 2, 1, X86DEC_OK, MN(LDS), 2, "lds eax, dword ptr ds:[ebx]"},
  ...
  {"\x0F\x20\x00", 3, 0, X86DEC_INVALID, MN(INVALID), 0, 0},
  ...
  {"\xF3\x0F\xAF\xC1", 4, 0, X86DEC_INVALID, MN(INVALID), 0, 0},
