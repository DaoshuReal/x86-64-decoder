...
[0x08] = {
  .variant_66 = V(M(ROUNDPS), 3, S(XMM_REG), S(XMM_OR_MEM), S(IMM8), 0),
},
[0x09] = {
  .variant_66 = V(M(ROUNDPD), 3, S(XMM_REG), S(XMM_OR_MEM), S(IMM8), 0),
},
[0x0A] = {
...
[0x14] = {
  .variant_66 = V(M(PEXTRB), 3, S(R32_OR_MEM), S(XMM_REG), S(IMM8), 0),
},
[0x15] = {
  .variant_66 = V(M(PEXTRW), 3, S(R32_OR_MEM), S(XMM_REG), S(IMM8), 0),
},
[0x16] = {
  .variant_66 = V(M(PEXTRD), 3, S(R32_OR_MEM), S(XMM_REG), S(IMM8), 0),
},
[0x17] = {
  .variant_66 = V(M(EXTRACTPS), 3, S(R32_OR_MEM), S(XMM_REG), S(IMM8), 0),
},
[0x20] = {
  .variant_66 = V(M(PINSRB), 3, S(XMM_REG), S(R32_OR_MEM), S(IMM8), 0),
},
[0x21] = {
  .variant_66 = V(M(INSERTPS), 3, S(XMM_REG), S(XMM_OR_MEM), S(IMM8), 32),
},
[0x22] = {
  .variant_66 = V(M(PINSRD), 3, S(XMM_REG), S(R32_OR_MEM), S(IMM8), 0),
},
[0x40] = {
